...
public class NBTPlayer implements PlayerOwnedObject {
	...
	public NBTPlayer(Nerd nerd) {
		this(nerd.getUniqueId());
	}
	...
	public List<ItemStack> getOfflineArmor() {
		final List<ItemStack> inventory = new NBTPlayer(this.getUuid()).getOfflineInventory();
	...
	public void setLocation(Location location) {
		...
		new Timer("    Update MVINV last world", () ->
			Athena.getMultiverseInventories().getData().updateLastWorld(getName(), location.getWorld().getName()));
	}
