...
import static net.aegis.athena.utils.TimeUtils.shortDateTimeFormat;

public class IOUtils {
	public final static String PLUGIN_ROOT = "plugins/" + Athena.class.getSimpleName() + "/";
	...
	private static void write(String fileName, List<StandardOpenOption> openOptions, UncheckedConsumer<BufferedWriter> consumer) {
		Tasks.async(() -> {
			synchronized (Athena.getInstance()) {
				try {
